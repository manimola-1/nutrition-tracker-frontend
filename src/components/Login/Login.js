    ...
    <div className="login-container">
      ...
      >
        <div className="login-image-overlay">
          ...
          <h1 className="login-title-main">Nutrition Tracker</h1>
        ...
        <div className="login-form-wrapper">
          <div className="login-form-card">
            ...
            <div className="login-header">
              ...
              <h2 className="login-title">Vitajte späť</h2>
            ...
            <form onSubmit={handleSubmit} className="login-form">
              ...
              <div className="login-signup">
                <span className="login-signup-text">Nemáte účet? </span>
                <button
                  type="button"
                  onClick={onNavigateToRegister}
                  className="login-signup-link text-yellow-500 !important bg-transparent border-none cursor-pointer p-0 font-inherit"
                >
