...
export const translations = {
    sk: {
        ...
        nav: {
            ...
            nutritionCalculator: 'Kalkulačka parenterálnej a enterálnej výživy pre KAIM',
            subtitle: 'Automatické dopočítanie rýchlosti v označenom riadku na odporúčaný cieľ kcal a proteínu podľa dňa hospitalizácie.',
        },
        ...
        patientHistory: {
            ...
            searchHelper: 'Vyhľadávanie pacientov podľa ID, počtu dní alebo posledného dňa. Výsledky sa aktualizujú automaticky počas písania.',
            patientId: 'ID pacienta',
            ...
            cumulativeProteinDiffMin: 'Kumulatívny rozdiel bielkovín (vs. dolný cieľ)',
            cumulativeProteinDiffMax: 'Kumulatívny rozdiel bielkovín (vs. horný cieľ)',
        },
        ...
        rampGraph: {
            ...
            achieved: 'Dosiahnuté (%)',
            description: 'Graf ukazuje plánovaný ramp-up % z plného cieľa (modrá čiara) pre dni 1-10. Bod označuje dosiahnuté % pre aktuálny deň',
    ...
    en: {
        ...
        nav: {
            ...
            nutritionCalculator: 'Parenteral and Enteral Nutrition Calculator for KAIM',
            subtitle: 'Automatic calculation of speed in the marked row to the recommended kcal and protein goal according to the day of hospitalization.',
        },
        ...
        patientHistory: {
            ...
            searchHelper: 'Search patients by Patient ID, Number of Days, or Last Day. Results will update automatically as you type.',
            patientId: 'Patient ID',
            lastDay: 'Last Day',
            ...
            cumulativeProteinDiffMin: 'Cumulative protein difference (vs. lower goal)',
            cumulativeProteinDiffMax: 'Cumulative protein difference (vs. upper goal)',
        },
        ...
        rampGraph: {
            ...
            achieved: 'Achieved (%)',
            description: 'The graph shows the planned ramp-up % of the full goal (blue line) for days 1-10. The point indicates the achieved % for the current day',
